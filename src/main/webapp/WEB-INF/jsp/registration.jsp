...
<html>
	<head>
		...
		<fmt:message bundle="${loc}" key="local.enterAddress" var="enterAddress" />
	...
	<header>
		...
		<br />
		   <form action="Controller" method="post" class="box">
			   ...
			   <input type="text" required name="name" value="" placeholder="${enterName}"/>
			   <input type="text" required name="surname" value="" placeholder="${enterSurname}"/>
			   <input type="text" required name="address" value="" placeholder="${enterAddress}"/>
